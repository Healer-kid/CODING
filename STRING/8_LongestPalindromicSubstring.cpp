...
LOGIC:
The idea is to check whether the two chars are same ,if so check whether the chars bw them also a palindrome
...
To generate odd length palindrome, Fix a centre and expand in both directions for longer palindromes, i.e. fix i (index) as center and two indices as i1 = i+1 
and i2 = i-1
